...
# Printing report of all resources, checking if resources are sufficient, make coffee
...
on = True
while on:
    choice = input(f"What would you like? Choose between espresso, latte or cappuccion: ")
    if choice == "off":
