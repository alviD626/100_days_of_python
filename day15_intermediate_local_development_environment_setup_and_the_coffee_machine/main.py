...
def deduct_resouce(coffee_choice):
...
def coffee_machine():
    ...
    while on:
        ...
        if choice == 'report':
            ...
            if process_coins(quarters, nickles, pennies) == MENU[choice]['cost']:
                deduct_resouce(choice)
                ...
                print(f"Not enough money, ${(process_coins(quarters, dimes, nickles, pennies) - MENU[choice]['cost'])} refunded.")
